...
public class AddStudent extends JFrame implements ActionListener{
    ...
    AddStudent() {
        ...
        String course[] = {"BS.c", "BBA", "MS.c", "LL.B", "B.A(Eng)", "M.A(Eng)", "MBA", "MCom", "MCA", "LL.M"};
        ...
        String department[] = {"Computer Science", "Business Administration", "Law And Justice", "Social Sciences"};
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "insert into student values('"+name+"', '"+fname+"', '"+rollno+"', '"+dob+"', '"+address+"', '"+phone+"', '"+email+"', '"+x+"', '"+xii+"', '"+nid+"', '"+course+"', '"+department+"')";
